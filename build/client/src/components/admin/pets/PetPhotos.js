...
const PetPhotos = ({ selectedPet }) => {
    ...
    return (<semantic_ui_react_1.Grid centered>
      <semantic_ui_react_1.Grid.Row>
        {loading ? (<semantic_ui_react_1.Loader />) : (<semantic_ui_react_1.Grid.Column width={16}>
            <semantic_ui_react_1.Header as='h3' textAlign='center' content={selectedPet ? `Agregar mas Fotos a ${selectedPet.name}` : 'Agregar Fotos'}/>
            <PhotosDropzone_1.PhotosDropzone handleSubmit={handlePhotosSubmit} setFiles={setFiles}/>
