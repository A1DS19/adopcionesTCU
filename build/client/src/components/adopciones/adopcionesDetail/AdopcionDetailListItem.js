...
const AdopcionDetailListItem = ({ selectedBreedPet, }) => {
    var _a;
    return (<semantic_ui_react_1.Card as={react_router_dom_1.Link} to={`/adoption/${selectedBreedPet === null || selectedBreedPet === void 0 ? void 0 : selectedBreedPet._id}`}>
      <semantic_ui_react_1.Image fluid src={((_a = selectedBreedPet.photosUrl) === null || _a === void 0 ? void 0 : _a.length) > 0
